...
public class TheLink extends FragmentActivity {
...
//		  myWebView.startAnimation(ZoomInAni); 
        ...
        final Button button = (Button) findViewById(R.id.button_TheLink);
        // Add a On Click Listener 
 //       button.setOnClickListener(this);
    	String url = "http://issuu.com/linkbcit";
    	goWeb(url);
  ...
  //  overridePendingTransition(R.anim.fadein, R.anim.fadeout);     
	   ...
	   public void goHome(View v){
	    	String url = "http://www.linknewspaper.ca/";
	    	goWeb(url);
//		  finish();
//		  super.onBackPressed();
	   }
...
//	   animatedStartActivity(CampusMap.class);
   ...
   public void showBCITWeb(View v){
	   	String url = "www.bcit.ca";
	   	goWeb(url);
		   
	   }
	       
   public void showBCITSAWeb(View v){
	   	String url = "https://twitter.com/LinkBCIT";
	   	goWeb(url);
   ...
   public void showBCISTSAlist(View v){
   	String url = "https://www.facebook.com/linkbcit";
   	goWeb(url);
