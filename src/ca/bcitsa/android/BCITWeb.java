...
import ca.bcitsa.android.BCITSAWeb.InnerWebViewClient;

public class BCITWeb  extends Activity  {
...
//		overridePendingTransition(R.anim.from_middle, R.anim.to_middle);
		setContentView(R.layout.bcitweb);
/*
...
//	   animatedStartActivity(CampusMap.class);
   ...
   public void goFacebook(View v){
	   	String url = "https://m.facebook.com/bcit.ca";
	   	goWeb(url);
   ...
   public void showBCISTSAlist(View v){
   	String url = "https://mobile.twitter.com/bcit";
   	goWeb(url);
